...
latex_documents = [
    (master_doc, 'burbuja.tex', 'burbuja Documentation',
     'burbuja', 'manual'),
]
...
man_pages = [
    (master_doc, 'burbuja', 'burbuja Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'burbuja', 'burbuja Documentation',
     author, 'burbuja', 'Bubble detection for molecular dynamics simulations.',
     'Miscellaneous'),
]
